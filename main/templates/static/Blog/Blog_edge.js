...
(function (compId) {
                    ...
                    dom: [
                        {
                            ...
                            },
                            {
                                ...
                                },
                                {
                                    ...
                                    cursor: 'pointer',
                                    fill: ['rgba(0,0,0,0)', '/static/Blog/images/Picture1.png', '0px', '0px']
                                }]
                            },
                            {
                                type: 'rect',
                        ...
                        },
                        {
                            ...
                            },
                            {
                                ...
                                fill: ['rgba(0,0,0,0)', '/static/Blog/images/ktj%20logo%20%2B%20text%20shapebsk-Recovered.png', '0px', '0px']
                            },
                            {
                            ...
                            },
                            {
                                ...
                                cursor: 'pointer',
                                fill: ['rgba(0,0,0,0)', '/static/Blog/images/iit%2Blogo%2Bwhite.png', '0px', '0px']
                            },
                            {
                                type: 'image',
                                ...
                                fill: ['rgba(0,0,0,0)', '/static/Blog/images/unesco-logo%2Bemblem_white.png', '0px', '0px']
                            }]
                        },
                        {
                            type: 'group',
                    ...
                    dom: [
                        {
                            ...
                            },
                            {
                                ...
                                fill: ['rgba(0,0,0,0)', '/static/Blog/images/381726_Satyarthi-Yousafzai.jpg', '0px', '0px']
                            },
                            {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("/static/Blog/Blog_edgeActions.js");
})("Blog_main");
